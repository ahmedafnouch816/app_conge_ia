...
SECRET_KEY = os.getenv(
    "SECRET_KEY", "django-insecure-u*d(hktq4idr60l0j*n5jzk61rqsh^q)+i_0i@$88c_ls9ccg%"
)
...
#FRONTEND_URL = "http://127.0.0.1:8000"  # use pour backend 
FRONTEND_URL = "http://localhost:3000"  # use pour frontend
